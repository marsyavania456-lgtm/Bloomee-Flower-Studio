...
@section('page-subtitle', 'Tambah buket bunga baru ke toko')
...
<div class="card">
    <div class="card-header">
        <span style="font-weight:600;color:var(--green-900);">🌺 Form Tambah Produk</span>
    </div>
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input type="text" name="name" class="form-control" required
                           value="{{ old('name') }}" placeholder="cth: Buket Rose Merah Premium">
                </div>
                <div class="col-md-4">
